import { Stocks } from "../../../../data/StockListTable";
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-[#243447] text-[11px] text-[#8a9bb0] uppercase">
              ...
              <th className="p-4 text-center font-medium">Min Threshold</th>

              <th className="p-4 text-center font-medium">Status</th>

              <th className="p-4 font-medium text-center">Supplier</th>

              <th className="p-4 text-center font-medium">Last Updated</th>
          ...
          <tbody>
            {Stocks.map((stock, index) => (
              ...
              >
                ...
                <td className="px-4 py-5 text-[14px] text-[#f0f4f8] text-center">
                  {stock.unit}
                </td>
                ...
                <td className="px-4 py-5 text-center">
                  <button className="border border-white/15 rounded-[10px] px-4 py-2 text-[14px] text-[#8a9bb0]">
                    {stock.action}
                  </button>
                </td>
              </tr>

...
function Titlesection(){
    ...
    return(
        <section
         className=" flex w-full min-w-0 min-h-[61px] flex-col  md:flex-row lg:flex-row md:items-center md:justify-between gap-[16px] md:gap-[24px]">
            ...
            <div className="flex w-full min-h-[61px] flex-col gap-[4px]">
                ...
                <p className="w-full min-h-[21px] font-dm font-[400] text-[16px] leading-none tracking-normal text-[#556070] ">
                   Manage discount coupons, tax rules, service charges, and billing configurations.
                </p>
            </div>

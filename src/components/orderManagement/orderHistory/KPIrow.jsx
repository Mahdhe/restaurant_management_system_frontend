...
const KPIrow = () => {
  return (
    ...
    <section className="w-[1132px] h-[120px] rounded-[14px] border-[1px] gap-[16px] flex bg-[#0F1923] border-[#0F1923] my-5">
        ...
        <div className="w-[271px] h-[120px] rounded-[14px] border-[1px] p-[16px] flex flex-col gap-[8px] flex bg-[#1C2A38] border-[#FFFFFF14]">

            <div className="w-[239px] h-[14px] gap-[10px] flex">
                <h1 className="w-[100px] h-[14px] font-[DM_Sans] font-semibold text-[11px] leading-[100%] tracking-[0.8%] text-[#8A9BB0]">TODAY’S ORDERS</h1>
            </div>

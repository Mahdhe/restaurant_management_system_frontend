...
const PhotoUploadCard = ({
  ...
  return (
    <div className="bg-[#1C2A38] border border-slate-800 rounded-xl p-4 flex items-center justify-between gap-4 mb-6">
      <div className="flex items-center gap-3">
        <span className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center shrink-0">
          <User size={18} className="text-gray-500" />
        </span>
        <div>
          <p className="text-[#E67E22] text-sm font-semibold">{label}</p>

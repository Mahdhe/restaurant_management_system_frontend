...
const Cards = () => {
    return (
        ...
        <section className="w-full h-[366px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 py-4">
            {menuItems.map((item, i) => (
                <div key={i} className="bg-[#1C2A38] p-2 rounded-[16px]">
                    ...
                    <div className="w-full h-auto rounded-b-[16px] border-[1px] py-[12px] px-[10px] gap-[8px] border-[#FFFFFF14]">
                        ...
                        <div className="w-full h-[28px] border-b-[1px] gap-[4px] flex justify-between items-center border-[#FFFFFF14] mb-2">
                            <h1 className="font-[DM_Sans] font-bold text-[24px] leading-[18px] tracking-[0.8px] text-[#E67E22]">{item.price}</h1>


                        </div>

                        <div className="flex gap-[10px] w-[147.5px] h-[40px] justify-between items-center">

                            <button className="w-[78.5px] h-[24px] rounded-[10px] py-[8px] px-[16px] gap-[8px] bg-[#2980B91F] border-[#2980B94D] border-[1px] flex justify-center items-center text-center">
                                <p className="font-[DM_Sans] font-semibold text-[14px] leading-[100%] tracking-[0%] text-[#2980B9]">Starters </p>
                            </button>

                            <button className="w-[59px] h-[40px] rounded-[10px] py-[8px] px-[16px] gap-[8px] bg-[#243447] border-[#FFFFFF24] flex justify-center items-center text-center">
                                <p className="font-[DM_Sans] font-semibold text-[14px] leading-[100%] tracking-[0%] text-[#F0F4F8]">Edit</p>
                            </button>

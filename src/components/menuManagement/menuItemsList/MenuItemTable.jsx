            ...
            <div className="w-[770px] h-[386px] py-[10px] gap-[12px] flex flex-col">
                ...
                <div className="w-[770px] h-[80px] rounded-t-[14px] gap-[10px] items-center flex">
                    <div className="w-[770px] h-[80px] border-b-[1px] py-[20px] px-[16px] border-[#FFFFFF14] flex items-center justify-between">
                        ...
                        <h3 className="w-[92.25px] h-[24px] font-[DM_Sans] font-bold text-[14px] leading-[100%] tracking-[0.8%] text-[#F0F4F8] flex items-center">Starters</h3>
                        <h3 className="w-[92.25px] h-[24px] font-[DM_Sans] font-bold text-[14px] leading-[100%] tracking-[0.8%] text-[#F0F4F8] flex items-center">LKR 650</h3>

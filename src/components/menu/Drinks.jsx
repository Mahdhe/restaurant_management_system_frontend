...
<section  
        className="relative w-full min-h-[747px] flex flex-col gap-10 opacity-100 py-10 px-6 md:px-10 md:gap-12 md:py-14 lg:gap-[65px] lg:px-[120px] lg:py-[72px] bg-main-gradient overflow-hidden">
...
font-dm font-[800] text-lg sm:text-xl  lg:text-[22px] leading-[18px] tracking-[0.04em] text-[#E67E22]">  04 - DRINKS    </h3>
...
<div className="w-full flex flex-col min-h-[58px] gap-[16px]">
    ...
    <div className="flex w-fit flex-col">
        <OrangeLine/>
     <h4 className="mt-0 flex h-auto min-h-[25px] w-fit min-w-[90px] whitespace-normal  font-playfair text-lg font-semibold
    leading-[25px] tracking-[0.008em] sm:text-xl lg:text-[22px] text-[#F0F4F8]">
Non- Alcoholic
        </h4> </div>


<p className="min-h-[23px] font-dm text-base font-normal leading-none tracking-[0.008em] opacity-100 sm:text-[17px] text-[#8A9BB0] lg:text-lg">
   A curated pour list, chosen to complement every course. </p>   
</div>
</div>
...
<div className="flex min-h-[66px] w-full flex-col gap-[24px] opacity-100"> 
    ...
    <div>
    <MenuFrame
    image="/menuimages/img9.png"
    title="Rose & Cardamom Cooler"
    description="Fresh rose syrup, Cardamom, Soda, lime."
    price="LKR 1,950"
/>
</div> 
...
<div>
<MenuFrame
    image="/menuimages/img10.png"
    title="Iced Saffron Lemonade"
    description="Saffron-infused lemonade, fresh mint."
     price="LKR 1,200"
/>
</div>

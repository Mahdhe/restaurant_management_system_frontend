...
<h4 className="text-left mt-0 min-h-[25px] w-fit shrink-0 font-dm text-2xl font-[500] leading-[25px] tracking-[0.008em] sm:text-[28px] lg:text-[32px] text-[#FFFFFF]"> 
{title}
</h4>
...
<section  
        className="relative w-full min-h-[975px] flex flex-col gap-10 opacity-100 py-10 px-6 md:px-10 lg:px-[120px]  md:gap-12 md:py-14 lg:gap-[65px] lg:py-[72px] bg-main-gradient overflow-hidden">
...
font-dm font-[800] text-lg sm:text-xl  lg:text-[22px] leading-[18px] tracking-[0.04em] text-[#E67E22]">  01 - STARTERS  </h3>
...
<p className="min-h-[23px] w-full  font-dm text-base font-normal leading-none tracking-[0.008em] opacity-100 sm:text-[17px] text-[#8A9BB0] lg:text-lg">
    Light, seasonal openings meant to set the pace for the evening </p>   
</div>
</div>
...
<div className="flex min-h-[66px] w-full flex-col gap-[24px] opacity-100"> 
    ...
    <div>
    <MenuFrame
    image="/menuimages/img1.png"
    title="Seared Scallop"
    badge="GF"
    description="Cauliflower puree, brown butter, finger lime."
    price="LKR 4,200"
/>
</div> 
...
<div>
<MenuFrame
    image="/menuimages/img2.png"
    title="Heirloom Tomato"
    badge="GF"
    description="Burrata, basil oil, aged balsamic, sourdough crumb."
     price="LKR 3,200"
/>
</div>
...
<div>
<MenuFrame
    image="/menuimages/img3.png"
    title="Foie Gras Torchon"
    badge="GF"
    description="Brioche toast, fig compote, port reduction."
     price="LKR 5,200"
/>
</div>
     </div>

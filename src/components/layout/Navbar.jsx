...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-[#0B1220] md:px-10 lg:px-20 py-4 flex items-center justify-between relative z-50">
      {/* Logo */}
      ...
      <div className="hidden md:flex items-center gap-3">
        <button
          ...
          className="w-9 h-9 flex items-center justify-center rounded-lg border border-slate-600 text-gray-300 hover:text-orange-500 hover:border-orange-500 transition-colors duration-200"
        >
          <Moon size={16} />
        </button>

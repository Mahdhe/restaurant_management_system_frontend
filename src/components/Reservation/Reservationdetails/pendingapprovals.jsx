...
<section className="w-full mt-[16px]">
...
{/* second box */}
<div className="min-h-[178px] w-full min-w-0 mt-[16px] rounded-[14px] p-[20px]  bg-[#1C2A38] border border-[#FFFFFF14]">

  <div className="flex flex-col  w-full min-w-0 min-h-[27px] pt-[3px] gap-[10px]">
     <span className="font-dm font-bold text-[18px] leading-none tracking-normal text-[#F0F4F8]">
       Approval Actions
     </span>
   
   <div className="flex flex-col w-full min-w-0 min-h-[92px] gap-[12px] pt-[3px]">
   
   <div className="w-full min-w-0  grid grid-cols-2 min-h-[40px] gap-[8px] items-center">
    ...
    font-dm font-semibold tracking-normal leading-none text-[14px]">
     ...
     <button className="min-h-[40px] w-full min-w-0 rounded-[10px] border border-[#E74C3C26] py-[8px] bg-[#E74C3C1F] text-[#E74C3C]
    font-dm font-semibold tracking-normal leading-none text-[14px]">
       Reject
    </button>
   </div>
   ...
   <div className="flex w-full min-w-0 min-h-[40px] rounded-[10px] px-[16px] py-[8px] gap-[8px] bg-[#243447] pt-[3px] items-center justify-center">   
<button className="
...
{/* third box */}
<div className="w-full min-w-0 min-h-[128px] mt-[16px] rounded-[14px] p-[20px]  bg-[#1C2A38] border border-[#FFFFFF14]">

<div className="flex flex-col min-w-0  w-full min-h-[128px] pt-[3px] gap-[14px]">
     <span className="font-dm font-bold text-[18px] leading-none tracking-normal text-[#F0F4F8]">
       Approval Actions
     </span>

<span className="w-full min-w-0 min-h-[42px] p-[12px] mt-[4px] border border-[#E74C3C] rounded-[12px] gap-[10px] bg-[#E74C3C1F]">

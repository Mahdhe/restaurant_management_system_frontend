...
className="flex min-h-[40px] items-center shrink-0 justify-center rounded-[10px] border border-[#556070] sm:w-[110px]
font-dm font-semibold text-[14px] tracking-normal leading-none text-[#556070] gap-[8px] px-[16px] ">
Assign Now
</button>
        </section>
    );
